...
$('.CardItems').click(function (event) {
...
function displayCart() {
    ...
    for (var i in cartArray) {
        output += "<tr>"
            ...
            + "<td>" + "<img  data-name='" + cartArray[i].image + "' src='" + cartArray[i].image + "' alt='' height='52'>" + "</td > "
...
$("body").on("click", "#confrimButton", function () {
    ...
    let reservationData = {
        ...
        ChoseTimeStart: $("#date-start").val(),
        ChoseTimeEnd: $("#mdate").val(),
